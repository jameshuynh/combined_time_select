...
module ActionView::Helpers
  class DateTimeSelector
    ...
    alias select_minute_without_simple_time_select select_minute
    alias select_minute select_minute_with_simple_time_select
    ...
    alias select_hour_without_simple_time_select select_hour
    alias select_hour select_hour_with_simple_time_select
    ...
    alias select_second_without_simple_time_select select_second
    alias select_second select_second_with_simple_time_select
    ...
    alias select_year_without_simple_time_select select_year
    alias select_year select_year_with_simple_time_select
    ...
    alias select_month_without_simple_time_select select_month
    alias select_month select_month_with_simple_time_select
    ...
    alias select_day_without_simple_time_select select_day
    alias select_day select_day_with_simple_time_select
  end
end
